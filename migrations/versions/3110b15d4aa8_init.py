...
Revision ID: 3110b15d4aa8
Revises: 
Create Date: 2025-09-19 12:39:34.924928
...
def upgrade() -> None:
    ...
    sa.Column('public_league_administrator_id', sa.String(length=16), nullable=False),
    sa.Column('geo_id', sa.String(length=250), nullable=False),
    ...
    sa.Column('league_admin_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_admin_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users_table.user_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('league_administrator_id'),
    sa.UniqueConstraint('public_league_administrator_id'),
    ...
    sa.Column('sender_entity_id', sa.String(), nullable=False),
    sa.Column('receiver_id', sa.String(), nullable=False),
    sa.Column('receiver_name', sa.String(length=255), nullable=False),
    sa.Column('receiver_entity_id', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('sent_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint('sender_id <> receiver_id', name='check_sender_receiver_not_equal'),
    ...
    sa.ForeignKeyConstraint(['to_id'], ['users_table.user_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('notification_id')
    )
    op.create_table('players_table',
    sa.Column('player_id', sa.String(), nullable=False),
    sa.Column('public_player_id', sa.String(length=16), nullable=False),
    sa.Column('user_id', sa.String(), nullable=False),
    ...
    sa.Column('total_fg2_made', sa.Integer(), nullable=False),
    sa.Column('total_fg2_attempts', sa.Integer(), nullable=False),
    sa.Column('total_fg3_made', sa.Integer(), nullable=False),
    sa.Column('total_fg3_attempts', sa.Integer(), nullable=False),
    sa.Column('total_ft_made', sa.Integer(), nullable=False),
    sa.Column('total_ft_attempts', sa.Integer(), nullable=False),
    sa.Column('total_join_league', sa.Integer(), nullable=False),
    sa.Column('is_ban', sa.Boolean(), nullable=False),
    sa.Column('is_allowed', sa.Boolean(), nullable=False),
    sa.Column('valid_documents', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('player_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('player_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users_table.user_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('player_id'),
    sa.UniqueConstraint('public_player_id'),
    sa.UniqueConstraint('user_id')
    )
    op.create_table('teams_table',
    sa.Column('team_id', sa.String(), nullable=False),
    sa.Column('public_team_id', sa.String(length=16), nullable=False),
    sa.Column('user_id', sa.String(), nullable=False),
    sa.Column('team_name', sa.String(length=100), nullable=False),
    sa.Column('team_address', sa.String(length=250), nullable=False),
    sa.Column('team_category', sa.String(length=250), nullable=True),
    sa.Column('contact_number', sa.String(length=15), nullable=False),
    ...
    sa.Column('team_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('team_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users_table.user_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('team_id'),
    sa.UniqueConstraint('public_team_id'),
    ...
    sa.Column('player_gender', sa.Enum('Male', 'Female', 'Any', name='category_allowed_gender_enum'), nullable=False),
    ...
    sa.Column('requires_valid_document', sa.Boolean(), nullable=False),
    sa.Column('allowed_documents', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('document_valid_until', sa.Date(), nullable=True),
    sa.Column('category_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('category_updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('public_league_id', sa.String(length=16), nullable=False),
    sa.Column('league_administrator_id', sa.String(), nullable=False),
    ...
    sa.Column('league_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['league_administrator_id'], ['league_administrator_table.league_administrator_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('league_id'),
    sa.UniqueConstraint('public_league_id')
    )
    op.create_table('matches_table',
    sa.Column('match_id', sa.String(), nullable=False),
    sa.Column('public_match_id', sa.String(length=16), nullable=False),
    ...
    sa.Column('minutes_per_quarter', sa.Integer(), nullable=False),
    sa.Column('court', sa.String(), nullable=True),
    sa.Column('referees', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('is_exhibition', sa.Boolean(), nullable=False),
    ...
    sa.Column('match_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('match_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['away_team_id'], ['teams_table.team_id'], ),
    sa.ForeignKeyConstraint(['home_team_id'], ['teams_table.team_id'], ),
    sa.PrimaryKeyConstraint('match_id'),
    sa.UniqueConstraint('public_match_id')
    )
    ...
    sa.Column('is_accepted', sa.Enum('Pending', 'Accepted', 'Rejected', 'Invited', 'Standby', 'Guest', name='player_is_accepted_enum'), nullable=False),
    sa.Column('player_team_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('player_team_updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('public_league_category_id', sa.String(length=16), nullable=False),
    sa.Column('category_id', sa.String(), nullable=False),
    sa.Column('league_id', sa.String(), nullable=False),
    sa.Column('max_team', sa.Integer(), nullable=False),
    sa.Column('accept_teams', sa.Boolean(), nullable=False),
    sa.Column('league_category_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_category_updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.UniqueConstraint('public_league_category_id')
    )
    op.create_table('league_category_rounds_table',
    sa.Column('round_id', sa.String(), nullable=False),
    sa.Column('public_round_id', sa.String(length=16), nullable=False),
    sa.Column('league_category_id', sa.String(), nullable=False),
    ...
    sa.Column('format_options', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('matches_generated', sa.Boolean(), nullable=False),
    sa.Column('round_status', sa.Enum('Upcoming', 'Ongoing', 'Finished', 'Cancelled', 'Postponed', name='round_status_enum'), nullable=False),
    sa.Column('next_round_id', sa.String(), nullable=True),
    sa.Column('league_category_round_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_category_round_updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.UniqueConstraint('public_round_id')
    )
    ...
    sa.Column('payment_status', sa.Enum('Pending', 'Paid Online', 'Paid On Site', 'No Charge', name='payment_status_enum'), nullable=False),
    ...
    sa.Column('league_team_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_team_updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.UniqueConstraint('team_id', 'league_id', name='uq_team_per_league')
    )
    op.create_table('league_matches_table',
    sa.Column('league_match_id', sa.String(), nullable=False),
    sa.Column('public_league_match_id', sa.String(length=16), nullable=False),
    sa.Column('league_id', sa.String(), nullable=False),
    sa.Column('league_category_id', sa.String(), nullable=False),
    sa.Column('round_id', sa.String(), nullable=False),
    sa.Column('home_team_id', sa.String(), nullable=False),
    ...
    sa.Column('quarters', sa.Integer(), nullable=False),
    sa.Column('minutes_per_quarter', sa.Integer(), nullable=False),
    sa.Column('minutes_per_overtime', sa.Integer(), nullable=False),
    sa.Column('court', sa.String(), nullable=True),
    sa.Column('referees', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('pairing_method', sa.String(), nullable=False),
    ...
    sa.Column('is_exhibition', sa.Boolean(), nullable=False),
    sa.Column('status', sa.Enum('Unscheduled', 'Scheduled', 'In Progress', 'Completed', 'Cancelled', 'Postponed', name='match_status_enum'), nullable=False),
    sa.Column('league_match_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_match_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['away_team_id'], ['league_teams_table.league_team_id'], ),
    sa.ForeignKeyConstraint(['home_team_id'], ['league_teams_table.league_team_id'], ),
    sa.ForeignKeyConstraint(['league_category_id'], ['league_categories_table.league_category_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['league_id'], ['leagues_table.league_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['round_id'], ['league_category_rounds_table.round_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('league_match_id'),
    sa.UniqueConstraint('league_id', 'league_category_id', 'round_number', 'home_team_id', 'away_team_id', name='unique_league_match_per_round'),
    sa.UniqueConstraint('public_league_match_id')
    )
    ...
    sa.Column('is_ban_in_league', sa.Boolean(), nullable=False),
    sa.Column('is_allowed_in_league', sa.Boolean(), nullable=False),
    sa.Column('league_player_created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('league_player_updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['league_category_id'], ['league_categories_table.league_category_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['league_id'], ['leagues_table.league_id'], ondelete='CASCADE'),
    ...
    sa.UniqueConstraint('league_category_id', 'player_team_id', name='uq_league_category_player'),
    sa.UniqueConstraint('league_id', 'player_team_id', name='uq_league_player'),
    sa.UniqueConstraint('league_team_id', 'player_team_id', name='uq_league_team_player')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('league_matches_table')
