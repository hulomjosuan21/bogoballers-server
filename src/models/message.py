...
class MessageModel(Base):
    ...
    message_id: Mapped[str] = UUIDGenerator("message") # don't worry this is autogenerated primary key
    ...
    sent_at: Mapped[datetime] = CreatedAt() # don't worry this is autogenerated timestamp
