...
class TeamManagerHandler:
    ...
    async def create_team_manager():
        ...
        if not email or not password_str or not contact_number or not display_name:
            return await ApiResponse.error("Missing required fields",status_code=400)
        ...
        async with AsyncSession() as session:
            ...
            try:
                ...
                return await ApiResponse.error("Email already exists",status_code=409)
    ...
    async def delete_team(team_id: str):
        ...
        async with AsyncSession() as session:
            ...
            if not team:
                return await ApiResponse.error(
                    "Team not found or you don't have permission to delete it.",
                    status_code=404
                )
